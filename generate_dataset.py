...
DEFAULT_OUTPUT_PATH = Path("dataset/loan_dataset.csv")
...
def generate_dataset(
    ...
    """Generate a synthetic credit-risk dataset and save it to disk."""
...
if __name__ == "__main__":
    ...
    print(f"Generated {len(dataset)} samples. Default rate: {dataset['default'].mean():.2%}")
